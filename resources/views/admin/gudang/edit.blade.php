                            ...
                            <div class="form-group">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <img src="{{asset('fotobarang/'.$dataBarang->gambar)}}" class="img-preview img-fluid mb-2" width="150px" height="150px" style="max-width: 150px; max-height: 150px">
                                        <label class="form-label"></label>
                                        <input class="form-control @error('gambar') is-invalid @enderror" value="{{old('gambar', $dataBarang->gambar)}}" type="file" name="gambar" id="gambar" onchange="previewImage()" placeholder="Upload Gambar">
                                        @error('gambar')
